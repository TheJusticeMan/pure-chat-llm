...
- :D **38% Smaller**: Optimized architecture (131KB bundle, down from 211KB in v1.x)
- [@] **Voice Calls**: Real-time voice conversations with tool access via OpenAI Realtime API
